...
import AnswerModal from "../components/AnswerModal1";
...
export default function NewGame() {
  ...
  function handleAddAnswer(answerObject) {}
            ...
            <div className="d-flex flex-row justify-content-around p-3 border border-2 border-primary-subtle rounded-3">
              ...
              <div className="d-flex flex-column justify-content-start align-items-start">
                ...
                {stage.topics.length > 0 ? (
                  stage.topics.map((topic) => (
                    <div
                      className="d-flex flex-column fs-4 mb-5"
                      key={topic.Name}
                    >
                      ...
                      <div className="d-flex flex-row align-items-center">
                        <div>
                          <span className="me-1">Answers:</span>
                        </div>
                        <div>
                          <button
                            className="d-flex btn btn-outline-success rounded-circle p-1"
